...
//
//	int queue_counter;
//	LinkedList* head_of_q;
//	LinkedList* tail_of_q;
//
//	Q()
//	{
//		this->head_of_q = this->tail_of_q = nullptr;
//	}
//
...
//		else
//		{
//			this->tail_of_q->next = node;
//			this->tail_of_q = this->tail_of_q->next;
//
//			EnterCriticalSection(&counter_section);
//
//			this->queue_counter++;
...
//			int data;
//
//			data = this->head_of_q->number;
//			LinkedList* temp = this->head_of_q;
//			this->head_of_q = this->head_of_q->next;
//			delete temp;
//
//			EnterCriticalSection(&counter_section);
//
